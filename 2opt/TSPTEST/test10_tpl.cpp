...
#define inName "p43a.txt"
#define cityNum 43
#define twoOptTimes 10000
#define OutName "answer.txt"
...
int main(void)
{
	...
	std::ofstream out(OutName);												//ファイル書き出し
	...
	std::uniform_int_distribution<> dist1(0, cityNum - 3);
	std::uniform_int_distribution<> dist2(2, cityNum - 1);
